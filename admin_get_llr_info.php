...
$sql1 = "SELECT aadhar,name,cov,llr_id,llr_status,mail_id,valid_till FROM llr";
...
<td align="left"><b>VALID TILL</b></td>
...
$row['valid_till'] . '</td><td align="left">' . 
...
$result2= mysqli_query($conn,"CALL PROC2()") or die("query fail:".mysqli_error());
echo"<b>NUMBER OF LLR ISSUED:</b>";
while ($row = mysqli_fetch_array($result2)){
	echo"<b>".$row['No_of_llr']."<b>";
	echo"<br/>";
